...
$email;
  ...
  if(isset($_POST['submit'])){
    ...
    $add_query="INSERT INTO emp (full_name,email,company,job_post,employee_level,address,tel,age,is_deleted,salary,img) 
      VALUES ('{$name}','{$email}','{$company}','{$job_post}',{$employee_level},'{$address}','{$tel}',{$age},2,'{$salary}','{$img_location}')
    ";
    ...
    if($result){
      ...
      $msg="this is neew";
      mymail($msg,$email);
      header('Location:my-employees.php?Employee_reg=true');
    }
    else{
      echo "database error";
    }
...
<html lang="en">
  <head>
    ...
    <title>Register Employee | Employee Management System</title>
  </head>
  <body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
      <div class="log" style="color: white;">Welcome New User | Have a Nice Day
    </form>
  </div>
</nav>
